...
{
    public class GrapplingHook_Test : MonoBehaviour
    {
    #region Variables
        ...
        // [CAN BE CHANGED]
        private PlayerMovementControl playerControl;         // Unity Standard Assets 
    ...
    #region StartUpdates
        ...
        {
            // [CAN BE CHANGED]
            playerControl = GetComponent<PlayerMovementControl>();
